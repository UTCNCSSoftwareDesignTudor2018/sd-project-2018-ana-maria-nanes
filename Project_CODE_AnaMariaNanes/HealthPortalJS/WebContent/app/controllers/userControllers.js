		...
		function($scope,$routeParams, $window, UserFactory) {
			...
			promise.success(function(data) {
			 ...
			 $scope.UpdateData = function(){	 
			  ...
			  UserFactory.updateUser(id,data,_config)
			           .success(function(){
			     ...
			     $scope.DeleteData = function(){
						  UserFactory.deleteUserById($scope.user.userId);  
						  $window.alert("The account has been deleted.");	
						  
						};	
		} ]);
	
	usersModule.controller('UserFruitsListController', [ '$scope', '$routeParams', '$window', 'FruitFactory', 'UserFactory',
	 ...
	 usersModule.controller('UserHerbListController', [ '$scope', '$routeParams', '$window', 'HerbFactory', 'UserFactory',
	  ...
	  usersModule.controller('UserVegetableListController', [ '$scope', '$routeParams', '$window', 'VegetableFactory', 'UserFactory',
			function($scope, $routeParams, $window, VegetableFactory, UserFactory) {
	   ...
	   usersModule.controller('UserHospitalListController', [ '$scope', '$routeParams', '$window', 'HospitalFactory', 'UserFactory',
			function($scope, $routeParams, $window, HospitalFactory, UserFactory) {
	   ...
	   usersModule.controller('UserDiseaseListController', [ '$scope', '$routeParams', '$window', 'DiseaseFactory', 'UserFactory',
			function($scope, $routeParams, $window, DiseaseFactory, UserFactory) {
		...
		usersModule.controller('UserCartController', [ '$scope', '$routeParams', '$window', 'UserFactory','ShoppingCartFactory',
			function($scope, $routeParams, $window, UserFactory,ShoppingCartFactory) {
				...
				var promise = ShoppingCartFactory.findShoppingCartOfUser(userId);
				promise.success(function(data) {
